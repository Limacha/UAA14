    ...
    internal class Program
    {
        static void Main(string[] args)
        {
                ...
                else if (key == ConsoleKey.U)
                {
                    ...
                    if (interupList.Count > 0)
                    {
                        ...
                        if (code != "exit")
                        {
                            ...
                            Console.Clear();
                            Console.ForegroundColor = ConsoleColor.DarkGray;
                            Console.WriteLine($"la lampe {interupteur.Lampe.Code} {interupteur.Lampe.ShowState()}");
                            Console.ResetColor();
                        }
                    }
                }
                else if (key == ConsoleKey.S) 
                {
                    ...
                    if (lampeList.Count > 0)
                    {
                        ...
                        if (code != "exit")
                        {
                            ...
                            Console.Clear();
                            Console.ForegroundColor = ConsoleColor.DarkGray;
                            Console.WriteLine($"la lampe {lampe.Code} {lampe.ShowState()}");
                            Console.ResetColor();
                        }
                    }
                }
            ...
            string ShowLampe()
            {
                ...
                { 
                    text += $"la lampe {lampe.Code} {lampe.ShowState()}\n";
                }
                return text;
            }
